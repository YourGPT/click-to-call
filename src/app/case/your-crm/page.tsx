...
const YourCRM = () => {
  ...
  const handleAgentSelect = (agent: (typeof agents)[number]) => {
    const confirmed = confirm(`Initiate call with ${agent.name}?\n\nSpecialty: ${agent.specialty}\n\nThis will start an AI-powered outbound call to the customer.`);
    if (confirmed) {
          ...
          <div className="bg-white rounded-xl p-6 shadow border border-slate-200 min-w-[280px]">
            ...
            <div className="flex flex-col gap-3">
              <div className={`dropdown relative w-full${isDropdownOpen ? " active" : ""}`}>
                <button
                  className={`w-full bg-blue-500 text-white border-none px-5 py-3 rounded-lg font-medium text-sm cursor-pointer transition-all flex items-center justify-between gap-2 ${isCallActive ? "bg-emerald-600" : ""} dropdownToggle`}
                  onClick={(e) => {
                    e.stopPropagation();
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    {isCallActive ? "Calling..." : "Call Customer"}
                  </div>
                ...
                <div
                  className={`dropdownMenu absolute left-0 right-0 bg-white border border-slate-200 rounded-lg shadow-lg z-[1000] mt-1 transition-all duration-200
              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-base text-slate-900 font-medium">{customerData.phone}</span>
                  </div>
                  <div className="flex flex-col gap-1">
